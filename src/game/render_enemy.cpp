...
namespace game
{
    ...
    static void render_enemy_attack(Enemy const&);
}
...
void game::render_enemy(Enemy const* _enemy)
{
    ...
    if(enemy.attacking)
        render_enemy_attack(enemy);
    else
        render_enemy_walking(enemy);
}

/**
 * The enemy texture looks like 2 lines with 4 frames.
 * Lines: left, right
 ...
 * Every sprite is 64x128
 */
void game::render_enemy_attack(Enemy const& enemy)
{
    static SDL_Texture* texture2 = utils::
        load_texture("assets/goblin-attack.png");
